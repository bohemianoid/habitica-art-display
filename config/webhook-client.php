...
return [
    'configs' => [
        [
             ...
             */
            'signature_validator' => \App\Http\Webhook\HabiticaSignatureValidator::class,

            /*
             * This class determines if the webhook call should be stored and processed.
             */
            'webhook_profile' => \App\Http\Webhook\HabiticaWebhookProfile::class,
             ...
             */
            'process_webhook_job' => \App\Jobs\ProcessHabiticaWebhook::class,
        ],
    ],
